...
MIDDLEWARE = [
    ...
    "core.common.middleware.TenantMiddleware",
...
AWS_S3_ADDRESSING_STYLE = config("AWS_S3_ADDRESSING_STYLE", "path")

AWS_DEFAULT_ACL = None

AWS_QUERYSTRING_AUTH = config("AWS_QUERYSTRING_AUTH", "False") == "True"
